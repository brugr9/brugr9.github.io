...
* Git Version Control, Documentation: [7.11 Git Tools - Submodules](https://git-scm.com/book/en/v2/Git-Tools-Submodules)
* Unreal Engine Documentation: [Rendering to Multiple Displays with nDisplay](https://docs.unrealengine.com/en-US/WorkingWithMedia/nDisplay/index.html)
